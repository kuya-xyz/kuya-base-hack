  ...
  try {
    if (Body.toLowerCase().startsWith('send $')) {
      ...
      await client.messages.create({
        ...
        to: recipientNumber,
        body: `Sent $${dollarAmount} ≈ ₱${pesoAmount.toFixed(2)} to 8886! Recipient texts CLAIM to receive in GCash. Tx: ${tx.hash.substring(0, 10)}... (Base mainnet rate ***DEMO ONLY***)` // Updated message
      });
